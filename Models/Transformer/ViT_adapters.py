...
if __name__ == '__main__':
    # model = ViTSeg_CNNprompt_adapt(adapt_method='MLP',num_domains=1,pretrained=True,pretrained_vit_name='deit_base_patch16_224-b5f2ef4d')
    model = ViTSeg_adapt(adapt_method='MLP',pretrained=True,pretrained_vit_name='deit_base_patch16_224-b5f2ef4d')
