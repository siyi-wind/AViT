...
if __name__ == '__main__':
    # model = SwinSimpleSeg_adapt(pretrained=True,adapt_method=False,num_domains=1)
    model = SwinSimpleSeg_CNNprompt_adapt(pretrained=True,adapt_method='MLP',num_domains=1)
